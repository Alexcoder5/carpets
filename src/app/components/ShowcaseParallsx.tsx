    ...
    <section className='bg-my-beige px-[1.6vw]' >
      <div className="h-[152vw] w-full relative">
        ...
        <div>
            ...
            <Parallax speed={0} className='w-[16vw] absolute top-[63vw] left-[17.7vw] z-10'>
            ...
            <Parallax speed={0} className='w-[16.1vw] absolute top-[72.6vw] right-0 z-10'>
                <Image draggable={false} src={egg} className='w-full' alt="sticker" />
            </Parallax>
            <Parallax speed={0} className='w-[24.1vw] absolute bottom-[33.9vw] right-[24.2vw] z-10'>
                <Image draggable={false} src={whiteBears} className='w-full' alt="sticker" />
            </Parallax>
            <Parallax speed={0} className='w-[16.1vw] absolute bottom-[7.17vw] left-[32.6vw] z-10'>
                <Image draggable={false} src={rainbowWaves} className='w-full' alt="sticker" />
            </Parallax>
            <Parallax speed={0} className='w-[16.1vw] absolute bottom-[-12vw] left-0 z-10'>
                <Image draggable={false} src={chessboard} className='w-full' alt="sticker" />
            </Parallax>
            <Parallax speed={0} className='w-[32.25vw] absolute bottom-[-3.1vw] right-0 z-10'>
