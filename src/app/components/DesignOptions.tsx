...
const DesignOptions = () => {
    return (
        <section className='bg-my-beige pt-[12vw] pb-[7vw] relative'>
            <Image src={gun} className='absolute top-[3%] right-[18%] w-[16vw]' alt="sticker"/>
            ...
            <div className='flex flex-1 items-center justify-center flex-col gap-[2vw] relative'>
                ...
                <h2 className='uppercase font-formom text-my-black text-custom-heading text-center '>
                Tufting allows  <br />
                a wide range  <br />
                of design options
                </h2>
                <p className='text-center font-thin text-my-black text-custom-paragraph'>
