    ...
    <div className='fixed top-0 z-50 pt-[1vw] w-full px-[1vw]'>
      <nav className='flex items-center justify-between px-[1.6vw] font-medium bg-[#EEE9D799] rounded-full border border-[#2E2D2299] backdrop-blur-sm'>
        <ul className='flex gap-[3.33vw] flex-1 items-center mb-[0.75vw] mt-[0.9vw]'>
          <li><Link className='text-custom-paragraph-sm flex items-center' href='#third_screen'>Shop</Link> </li>
          <li><Link className='text-custom-paragraph-sm flex items-center' href='#workshop'>Workshops</Link> </li>
          <li><Link className='text-custom-paragraph-sm flex items-center' href='#about'>About</Link> </li>
        </ul>
        ...
        <ul className='flex gap-[3.33vw] flex-1 justify-end items-center'>
          <li><Link className='text-custom-paragraph-sm flex items-center' href='#info'>Info</Link> </li>
